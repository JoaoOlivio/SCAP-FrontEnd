...
const Form = ({ handleSubmit, handleChange, errors, inputs }) => {
    return (
        <form onSubmit={handleSubmit} noValidate autoComplete="off">
            ...
            <FormInput type="text" field="razaoSocial" label="Razão Social" placeholder="Razão social" error={errors?.razaoSocial} onChange={handleChange} value={inputs?.razaoSocial} />
